...
export default function OnSiteSupport() {
  ...
  useEffect(() => {
    setOnsiteEnabled(localStorage.getItem("enableOnSite") === "true");
  }, []);
  ...
  <div className="add-btn-wrapper">
    <button
      ...
      disabled={!onsiteEnabled}
      title={
        !onsiteEnabled
          ? "On-site request will be enabled when BD team recommends it"
          : ""
      }
    >
      <FaPlus /> New Request
        ...
        <div className="add-btn-wrapper">
          ...
          {!onsiteEnabled && (
            <span className="tooltip-text">
              On-site request enabled after BD team approval
            </span>
          )}
        </div>
      </div>
          ...
          requests.map((req, index) => (
            <div className="onsite-card" key={index}>
              ...
              <div className="onsite-card-body">
                ...
                <p>
                  <strong>Rfported By:</strong> {req.reportedBy}
                </p>
              </div>
